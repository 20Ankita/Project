...
if(isset($_POST['submit'])){
	$text=$_POST['text'];
	$v="INSERT INTO tb_ce(text)VALUE('$text')";
...
<html>
	...
	<div class="container-fluid">
		<div class="row t2">
			<div class="col-md-12">
			<span>Admin conference and events
			</span>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<tr>
			<td><button type="submit" class="btn btn-success btn-lg" name="submit" style="margin-left:408px";>submit</button></td>
			</tr>
			</form>
		<div class="container-fluid">
		<div class="row">
