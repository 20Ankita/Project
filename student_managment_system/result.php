<?php
	...
	if(isset($_POST['submit'])){
		...
		$v = "UPDATE tb_stu_reg SET result = '$result' WHERE id = '$id'";
...
<html>
    ...
    line-height: 1.5;
    border-radius: 9px;
    padding: 75px 0px 60px 109px;
    margin: 160px 525px 225px 562px;
    font-size: 30px;
	}
	label{
		color:white;
	...
	<div class="container-fluid ">
		...
		<div class="col-md-12 a1">
			...
			<label style="padding-left:11px; font-size:30px;"><b>Enter the student result</b></label><br>
