<?php
	$c=mysqli_connect('localhost','root','','db_sms');
		...
		if(isset($_POST['submit'])){
			...
			$v="INSERT INTO  tb_departli(departid,dename,prepic,prenm,predes,hodpic,hodnm,hoddes)VALUES
			('$departid','$dename','$prepic','$prenm','$predes','$hodpic','$hodnm','$hoddes')";
...
<html>
	...
	.frm1{
		...
		margin: 100px 317px 115px 330px;
		font-size: 20px;
	}
	.a1{
		text-align:center;
	...
	<form name="name" method="post" class="frm1" enctype="multipart/form-data">
			...
			<td> <input value="<?php echo $id; ?> "name="departid" ></td>
			</tr>
			<tr>			
			<td><label>Department Name</label></td>
			<td><input  type="text" name="dename">
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="prenm"></td>
			</tr>
			<tr>
				<td><label>DESCRIPTION:</label></td>
				<td><textarea name="predes"></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				<td><label>PIC:</label></td>
				<td><input type="file" name="hodpic"></td>
			</tr>
			<tr>
				<td><label>NAME:</label></td>
				<td><input type="text" name="hodnm"></td>
			</tr>
			<tr>
				<td><label>DESCRIPTION:</label></td>
				<td><textarea name="hoddes"></textarea></td>
			</tr>
			...
			<tr>
				<td colspan="2"><a href="ad_faclist.php?deprtid=<?php echo $id;?>" class="btn btn-primary">ADD FACULTY</a></td>
