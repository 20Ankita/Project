...
<div class="col-md-12 img">
	...
	<div class="col-md-12">
		...
		<button type="submit"class="btn btn-success btn-lg bt2" name="submit"><a href="ad_studepart.php" style="color:white;">ADD</a></button>
	<form>
	<table border="1" class="t2">
		...
		echo'<td><a href="ad_studepartde.php?diide='.$v2["id"].'">Delete</a></td>';
