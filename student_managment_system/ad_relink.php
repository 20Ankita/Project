...
if(isset($_POST['submit'])){
	$text=$_POST['text'];
	$v="INSERT INTO tb_related(text)VALUE('$text')";
...
<html>
	...
	<style>
	.b1{
	background-image:url('asset/images/relink.jpg');
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<tr>
				<td>
				<div class="one"><textarea name="text" cols ="95" rows="20"> </textarea> </div>
				</td>
			</tr>
			</table>
			<tr>
