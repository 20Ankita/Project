...
<div class="col-md-12 img">
	...
	<table border="1" class="t2">
		...
		echo'<td><button type="submit"><a href="ad_decourse.php?course='.$v2['id'].'">delete</a></button></td>';
		echo'<tr>';
		$i++;
		}
		?>
		...
		<tr>
		<td colspan="4" style="padding-left:479px;"><input type="submit"></td>
		</tr>
