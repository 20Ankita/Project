...
<html>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<button type="button" class="btn btn-success btn-lg" style="margin-left:50px;"><a href="ad_terms.php">Click here</a></button>
			<form name="name" method="post" class="frm1">
			<table border="1" style="width:100%";>
			<tr >
			<td colspan="3" style="text-align:center;">Terms and condition</td>
			</tr>
			<tr>
			<?php
			...
			echo'<td>'.$i.'</td>';
			echo'<td>'.$v2["text"].'</td>';
			echo'<td><a href="ad_termsde.php?tid='.$v2["id"].'">Delete</a></td>';
			echo'</tr>';
			$i++;
			}
			?>
