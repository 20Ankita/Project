...
<html>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<button type="button" class="btn btn-success btn-lg" style="margin-left:50px;"><a href="ad_holiday.php">Click here</a></button>
			<form name="name" method="post" class="frm1">
			<table border="1" style="width:100%";>
			<tr>
			<td colspan="5" style="text-align:center;"> Holiday list</td>
			</tr>
			<tr>
			<?php
			...
			echo'<td>'.$v2["week"].'</td>';
			echo'<td>'.$v2["date"].'</td>';
			echo'<td><a href="ad_holidayde.php?hid='.$v2["id"].'">Delete</a></td>';
			echo'</tr>';
			$i++;
			}
			?>
